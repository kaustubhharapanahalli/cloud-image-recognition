...
from sqs_request_queue import receive_and_delete_messages, sendMessage
...
def upload_file():
    if request.method == "POST":
        ...
        while True:
            ...
            result = receive_and_delete_messages(
                "Shrav-Response-Queue.fifo",
                max_queue_messages,
                sqs_client,
                key_name,
            )
